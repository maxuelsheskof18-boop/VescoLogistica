// vesco-firebase-realtime.js — VESCO CONTROL V10.8 SHARE DIRECT
...
(function(){
  ...
  async function ensureFirebase(){
    ...
    initialized = true;
    console.log("VESCO Firebase V10.8 conectado:", cfg.databaseURL);
    return db;
  }
  ...
  function patchVescoV8Methods(){
    ...
    console.log("VESCO Firebase V10.8: métodos do painel sincronizados.");
  }
  ...
  boot().catch(e=>console.error("VESCO Firebase V10.8 erro:", e));
})();
