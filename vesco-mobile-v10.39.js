// vesco-mobile-v10.39.js — responsividade universal: desktop, tablet, Android e iOS.
(function(){
  'use strict';
  if(window.VescoMobileV1039) return;
  ...
  function normalizePendingForm(){
    ...
    modal.classList.add('v1039-pending-open');
    $$('.v1039-control,#v92PedidoModal input.v8-input,#v92PedidoModal select.v8-input,#v92PedidoModal textarea.v8-input',modal).forEach(control=>{
  ...
  window.VescoMobileV1039={
    ...
    debug:()=>({
      ...
      pendingFormFixed:true,flexActionsTouchSafe:true,pendingControls:document.querySelectorAll('#v92PedidoModal .v1039-control').length,tables:document.querySelectorAll('.vesco-responsive-table').length,buttons:document.querySelectorAll('.vesco-tap-ready').length,tapFallback:true
    })
  };
  // Compatibilidade com chamadas do núcleo V10.35.
  window.VescoMobileV1037=window.VescoMobileV1039;
  window.VescoMobileV1035=window.VescoMobileV1039;
  window.VescoMobileV1034=window.VescoMobileV1039;
