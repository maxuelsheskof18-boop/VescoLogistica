// vesco-mobile-v10.56.js — navegação mobile confiável; nenhuma alteração estrutural no desktop
(function(){
  "use strict";
  if(window.VescoMobileV1056) return;
  ...
  window.VescoMobileV1056={
    version:"V10.56-MOBILE-NAVEGAVEL-DESKTOP-PRESERVADO",
  ...
  console.log("VESCO Mobile V10.56 ativo — navegação retorna ao topo e desktop permanece original.");
})();
