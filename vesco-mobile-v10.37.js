// vesco-mobile-v10.37.js — responsividade universal: desktop, tablet, Android e iOS.
(function(){
  'use strict';
  if(window.VescoMobileV1037) return;

  const VERSION='V10.37';
  const PHONE_MAX=767;
  ...
  window.VescoMobileV1037={
    ...
    debug:()=>({
      ...
      tables:document.querySelectorAll('.vesco-responsive-table').length,buttons:document.querySelectorAll('.vesco-tap-ready').length,tapFallback:true
    })
  };
  // Compatibilidade com chamadas do núcleo V10.35.
  window.VescoMobileV1035=window.VescoMobileV1037;
  window.VescoMobileV1034=window.VescoMobileV1037;
